...
/// 
/// \details InROOT_Gen is used to take event vertices generated by
...
///       /generator/add inroot filename[:POSITION][:TIME][:NEVENTS][:NOFFSET]
///
...
#ifndef __RAT_InROOT_Gen_
#define __RAT_InROOT_Gen_
...
class InROOT_Gen: public GLG4Gen {
public:
  InROOT_Gen() : fStateStr(""), fCurrentEvent(0), fNumEvents(0), fMaxEvent(0), fLastEventTime(0), fTimeGen(0), fPosGen(0) {};
  virtual ~InROOT_Gen(){};
