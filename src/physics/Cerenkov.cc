...
//
//
// $Id: Cerenkov.cc,v 1.27 2010-06-16 15:34:15 gcosmo Exp $
...
{
        G4cout << "Cerenkov::Cerenkov constructor" << G4endl;
...

{
	...
	if (verboseLevel>0) {
	G4cout << "\n Exiting from Cerenkov::DoIt -- NumberOfSecondaries = " 
			      ...
			      G4MaterialPropertyVector* Rindex) const
{
	...
	return NumPhotons / RAT::PhotonThinning::GetFactor();
}
