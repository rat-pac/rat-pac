...
hxy2 = hxy.Clone("hxy2")
htime_tot = ROOT.TH1D("ht","",100, 0, 200)
...
htprompt_tot = ROOT.TH1D("ht_prompt","",100, 0, 50)
...
hid = ROOT.TEllipse( 0, 0, 50, 50 );
hid.SetFillColor( 0 )
hid.SetFillStyle( 0 )
hid.SetLineWidth(2)
hv = ROOT.TEllipse( 0, 0, 50, 50 );
hv.SetFillColor( 0 )
hv.SetFillStyle( 0 )
hv.SetLineWidth(2)
hod = ROOT.TEllipse( 0, 0, 51, 51 );
hod.SetFillColor( 0 )
hod.SetFillStyle( 0 )
hod.SetLineWidth(2)
...
for iev in xrange(0,nevents):
    ...
    for ipart in xrange(0,mc.GetMCParticleCount()):
        ...
        print "  ",ipart,") pdg=",mc.GetMCParticle(ipart).GetPDGCode()," Mom=",pmom,"=",mom.X(),",",mom.Y(),",",mom.Z()," ke=",ke," pos=",pos.X()*0.1,pos.Y()*0.1,pos.Z()*0.1,"r=",posr
    ...
    if npes>0:
        ...
        for ipmt in xrange(0,npmts):
            ...
            if pmtid>=90000:
                nvetopmts += 1
                print "veto pmt ",pmtid,": ",x,y,z,", r=",sqrt(x*x+y*y)
            if pmtid<90000:
