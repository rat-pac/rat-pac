...
htprompt_tot = ROOT.TH1D("ht","",500, 0, 500)
htprompt_ceren = htprompt_tot.Clone( "htime_ceren" )
htprompt_scint = htprompt_tot.Clone( "htime_scint" )
htprompt_reemit = htprompt_tot.Clone( "htime_reemit" )
