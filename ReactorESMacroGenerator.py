...
prefactor = num_electrons/(4. * 3.14159 * ((standoff*(1e5))**2))
    
result = prefactor * ((U235fissionrate*U235_integral) + (U238fissionrate*U238_integral) + (Pu239fissionrate*Pu239_integral) + (Pu241fissionrate*Pu241_integral)) * (time*3600.*24.*365.)
...
if (visualization):
	myfile.write('/vis/open OGLSX 1000x100\n')
